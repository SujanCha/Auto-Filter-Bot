...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ʙᴀᴄᴋᴜᴘ ᴄʜᴀɴɴᴇʟ', url="https://t.me/FilmyAdda_1")
        ],[
        ...
        await query.message.edit_text(
            ...
            cnlbtn = [[
                      InlineKeyboardButton('ᴄʜᴀɴɴᴇʟ', url='t.me/FilmyAdda_1')
                     ], [
                      InlineKeyboardButton('Owner', url='t.me/Sujan_Ch'),
                      InlineKeyboardButton('ᴜᴘᴅᴀᴛᴇs', url='t.me/FilmyAdda_1')
                     ], [
                      InlineKeyboardButton("⟸ Bᴀᴄᴋ", callback_data="start")
                     ]]
